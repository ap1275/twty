...
var (
	PasswordString = os.Getenv("TWTY_PASSWORD") // must be 16, 24 or 32 bytes
...
func getConfig() (string, map[string]string, error) {
	...
	if err != nil {
		config["ClientToken"] = os.Getenv("TWTY_CLIENT_TOKEN")
		config["ClientSecret"] = os.Getenv("TWTY_CLIENT_SECRET")
	} else {
		// decrypt
